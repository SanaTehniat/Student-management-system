    ...
    switch (studentData.qua)
     {
        case "Matric":
            let totalMarks = 850
            let obtainedMarksMatric = await inquirer.prompt
            ([{message: (chalk.green("Enter your obtained marks out of 850")),
                name:"ObtainMarks",
                type: "number",
            }])
            ...
            case "Intermediate":
                ...
                let obtainedMarksInter = await inquirer.prompt
                ([{message: (chalk.green("Enter your obtained marks out of 1100")),
                    name:"ObtainMarks",
                    type: "number",
                }])
